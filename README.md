...
<div class="bs-stepper">
  <div class="bs-stepper-header" role="tablist">
    ...
    <div class="step" data-target="#logins-part">
      <button type="button" class="btn btn-link bs-stepper-btn step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
    ...
    <div class="step" data-target="#information-part">
      <button type="button" class="btn btn-link bs-stepper-btn step-trigger" role="tab" aria-controls="information-part" id="information-part-trigger">
